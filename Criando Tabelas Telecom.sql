...
create table Equipamento(EquipID int, Name varchar(30), IP  varchar(30), Modelo varchar(50), Fabricante varchar(50), Shelf varchar(30), DataAquisicao date, Site int, Tipo varchar(30), Numero_Serie int, primary key(EquipID, Shelf), foreign key(Site) references Site(SiteID));
